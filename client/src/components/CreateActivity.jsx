...
const CreateActivity = () => {
    ...
    return (
        <div className='divcreate'>
            <Link to='/countries'><button className='back'>Back</button></Link>
            <h2 className='title'>Add a new tourist activity 🏄</h2>
            <form className='formCreate' onSubmit={handleSubmit}>
                <label className='lab'>
                    Name
                    <input required='required' className='inputName' type="text" onChange={e => handleChange(e)} name="name" value={input.name}/>
                ...
                <label className='lab'>
                    Difficulty
                    <select required='required' className='selectDif' name="difficulty" onChange={e => handleChange(e)}>
                        <option selected disabled hidden style={{display: 'none'}} value='defaultValue'>-</option>
                ...
                <label className='lab'>
                    Duration (min)
                    <input className='inputDur' type="number" onChange={handleChange} required='required' name="duration" value={input.duration}/>
                ...
                <label className='lab'>
                    Season
                    <select required='required' className='selectSea' name="season" onChange={handleChange}>
                        <option selected disabled hidden style={{display: 'none'}} value='defaultValue'>-</option>
                ...
                <label className='lab'>
                    Countrie/s
                    <select className='selectCount' required='required' name="country" onChange={e => handleSelect(e)}>
                        { allCountries?.map(c => {
                ...
                <button className='btnSubmit' disabled={button} type="submit" onClick={handleSubmit}>Add Activity</button>
            </form>
        </div>
    )
}
